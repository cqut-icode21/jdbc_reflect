...
public class DatabaseReflect implements BaseDao {
     ...
     */
    @Override
    public <T> List<T> findAll(Class<T> clazz) throws SQLException, InstantiationException, IllegalAccessException {
...
//            预定义
            ...
            i = statement.executeUpdate();//executeUpdate进行修改，并返回一个值将其赋值给i
