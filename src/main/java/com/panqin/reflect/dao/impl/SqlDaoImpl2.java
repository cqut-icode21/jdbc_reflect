 ...
 */
public class SqlDaoImpl2 implements SqlDao {
    /**
     * 查询所有的SQL语句
     *
     * @param clazz 类
    ...
    //        statement.executeUpdate("delete from student where sname='圆精查' ;");//删除            运行insert/update/delete操作，返回更新的行数。
    /**
     * 删除
     *
     * @param clazz 类
    ...
    public String deleteSql(Class<?> clazz) {
        ...
        System.out.println("deleteByIdSql:" + sql.toString());
        return sql.toString();
    }
    ...
    public String updateSql(Class<?> clazz) {
        ...
        System.out.println("updateByIdSql:" + sql.toString());
        return sql.toString();
    }
}
